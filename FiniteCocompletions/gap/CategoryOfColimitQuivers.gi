...
##
InstallMethod( ExtendFunctorToFiniteColimitCocompletionWithStrictCoproducts,
        "for a functor",
        [ IsCapFunctor ],
  ...
  function( G )
    ...
    G_UC := ExtendFunctorToFiniteStrictCoproductCocompletion( G );
    
    ColimitQuivers := FiniteColimitCocompletionWithStrictCoproducts( C );
    
    G_ColimitQuivers := CapFunctor( Concatenation( "Lift to FiniteColimitCocompletionWithStrictCoproducts( Source( ", Name( G ), " ) )" ), ColimitQuivers, D );
...
##
InstallMethod( ExtendYonedaEmbeddingToFiniteColimitCocompletionWithStrictCoproducts,
        "for a CAP category",
        [ IsCapCategory ],
        
  function( C )
    
    return ExtendFunctorToFiniteColimitCocompletionWithStrictCoproducts( YonedaEmbedding( C ) );
...
InstallMethod( CoYonedaLemmaEquivalence,
  ...
  function( C )
    ...
    CoYo := CapFunctor( Concatenation( "CoYonedaLemmaEquivalence( ", Name( C ), " )" ),
                    PSh,
                    FiniteColimitCocompletionWithStrictCoproducts( C ) );
...
InstallMethod( ExtendFunctorToCategoryOfPreSheaves,
  ...
  function( G )
    ...
    return PreCompose( CoYonedaLemmaEquivalence( SourceOfFunctor( G ) ),
                   ExtendFunctorToFiniteColimitCocompletionWithStrictCoproducts( G ) );
